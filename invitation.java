...
@Route(value = "Page6")
public class invitation extends VerticalLayout {
	
	ArrayList<Profile> profiles = new ArrayList<Profile>();
	
	public invitation(@Autowired GreetService service) {
	Scanner s1 = null;
	H4 message = new H4("These Students Would Like to Invite a Teacher");
    try {
	...
	//Grid displays all players who want to invite a teacher
